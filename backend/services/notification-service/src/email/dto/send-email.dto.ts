import { IsString, IsOptional, IsArray, IsBoolean, IsEmail, IsEnum } from 'class-validator';
import { EmailProvider } from '../entities/email-log.entity';
