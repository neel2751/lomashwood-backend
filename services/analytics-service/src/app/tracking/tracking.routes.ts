...
// Expose a router for mounting in the HTTP layer. Routes are implemented elsewhere
// (the service logic lives in this file). Exporting an empty router keeps the
// application wiring valid while preserving existing service code.
