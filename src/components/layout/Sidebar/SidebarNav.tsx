    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Packages", href: "/products/package" },
          { label: "Style", href: "/products/style" },
          { label: "Finish", href: "/products/finish" },
    ...
    items: [
      {
        ...
        icon: FileText,
        children: [
          { label: "Home Page", href: "/content/hero" },
          { label: "Brochure", href: "/content/brochures" },
