...
export const APP_VERSION = (process.env.NEXT_PUBLIC_APP_VERSION as string | undefined) ?? "1.0.0";
...
export const GTM_ID = (process.env.NEXT_PUBLIC_GTM_ID as string | undefined) ?? "";
export const GA_MEASUREMENT_ID = (process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID as string | undefined) ?? "";
...
export const PRODUCT_FINISH_OPTIONS = [
  ...
  { label: "Handleless", value: "handleless" }, // cspell:ignore handleless
...
export const CONTACT_EMAIL_KITCHEN = (process.env.NEXT_PUBLIC_KITCHEN_EMAIL as string | undefined) ?? "kitchen@lomashwood.com";
export const CONTACT_EMAIL_BEDROOM = (process.env.NEXT_PUBLIC_BEDROOM_EMAIL as string | undefined) ?? "bedroom@lomashwood.com";
export const CONTACT_EMAIL_BUSINESS = (process.env.NEXT_PUBLIC_BUSINESS_EMAIL as string | undefined) ?? "business@lomashwood.com";